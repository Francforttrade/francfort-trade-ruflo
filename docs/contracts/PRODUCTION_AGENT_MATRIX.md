...
| COMPLIANCE | Regra por produto/mercado/versão/vigência | Fonte de requisito, limites exatos, mercado desconhecido | Resultado inconclusivo bloqueia avanço proposto; decisão técnica responsável. Procedimento de conduta "Etiquetas" (fora do padrão importador/especial) já incorporado em [COMPLIANCE.md](COMPLIANCE.md) |
