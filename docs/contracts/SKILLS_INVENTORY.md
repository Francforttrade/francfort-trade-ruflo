...
| [COMERCIAL](COMERCIAL.md) | Preparação de oferta; análise de desvio; acompanhamento de negociação | Cálculos no módulo determinístico; limite desconhecido não é aprovação. Papel de interlocução comercial mapeado em [PROCEDIMENTOS_CONDUTA.md](PROCEDIMENTOS_CONDUTA.md), ainda não incorporado (3º lote) |
...
| [COMPLIANCE](COMPLIANCE.md) | Conferência de requisitos; avaliação documental; acompanhamento de validade | Regras objetivas pertencem ao módulo; ausência de dado não vira aprovação. Procedimento "Etiquetas" mapeado em `PROCEDIMENTOS_CONDUTA.md`, ainda não incorporado (3º lote) |
